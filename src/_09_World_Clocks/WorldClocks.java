...
public class WorldClocks implements ActionListener {
    ...
    public WorldClocks() {
    	...
    	panel.add(textArea);        panel.add(button);
    ...
    public void actionPerformed(ActionEvent arg0) {
    	...
    	if(arg0.getSource() == button) {
    		city = JOptionPane.showInputDialog(null, "Enter city and country in the following format: city, country (all caps)");
    		...
    		for(String city : cities.keySet()){
    	        ...
    	        timeZone =  cities.get(city); //clockUtil.getTimeZoneFromCityName(city);
            	...
            	textArea.setText(textArea.getText() + city + "\n" + dateStr + "\n" + timeStr + "\n\n");
            	frame.pack();
